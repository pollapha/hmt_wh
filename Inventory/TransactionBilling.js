var header_TransactionBilling = function () {
    var menuName = "TransactionBilling_", fd = "Inventory/" + menuName + "data.php";
    ...
    function exportExcel(btn) {
        ...
        if (dataT1.count() > 0) {
            ...
            worker.addEventListener('message', function (e) {
                saveAs(e.data, 'transaction_billing' + dayjs().format('YYYYMMDDHHmmss') + ".xlsx");
                btn.enable();
    ...
    return {
        view: "scrollview",
        scroll: "native-y",
        id: "header_TransactionBilling",
        body:
        {
            id: "TransactionBilling_id",
            type: "clean",
            rows:
                [
                    { view: "template", template: "Transaction Billing", type: "header" },
                    {
                        view: "form",
                        id: $n("form1"),
                        elements:
                                        ...
                                        [
                                            {
                                                rows: [
                                                    {},
                                                    vw1("button", 'btnExport', "Export Billing", {
                                                        ...
                                                        on: {
                                                            onItemClick: function () {
                                                                ...
                                                                if (dataT1.count() != 0) {
                                                                    ...
                                                                    webix.alert({
                                                                        title: "<b>ข้อความจากระบบ</b>", type: 'alert-warning', ok: 'ตกลง', text: 'ไม่พบข้อมูลในตาราง', callback: function () {
                                                                            ele("btnExport").enable();
                                                                        }
                                                                    });
                                                                }
                                            ...
                                            },
                                            {
                                                rows: [
                                                    {},
                                                    vw1("button", 'btnExport2', "Export Report (Onhand)", {
                                                        width: 180, css: "webix_orange",
                                                        icon: "mdi mdi-table-arrow-down", type: "icon",
                                                        tooltip: { template: "ส่งอีเมล์", dx: 10, dy: 15 },
                                                        on: {
                                                            onItemClick: function () {
                                                                // exportExcel(this);
                                                                ele("btnExport2").disable();
                                            ...
                                            },
                                            {
                                                rows: [
                                                    {},
                                                    vw1("button", 'btnExport3', "Send Report (Onhand)", {
                                                        width: 180, css: "webix_pink",
                                                        icon: "mdi mdi-email", type: "icon",
                                                        tooltip: { template: "ส่งอีเมล์", dx: 10, dy: 15 },
                                                        on: {
                                                            onItemClick: function () {
                                                                // exportExcel(this);
                                                                    ...
                                                                    setTimeout(function () {
                                                                        $.post(fd, { obj: obj, type: 4 })
                                                                            .done(function (data) {
                                                                                ...
                                                                                if (json.ch == 1) {
                                                                                    webix.alert({
                                                                                        title: "<b>ข้อความจากระบบ</b>", type: "alert-complete", ok: 'ตกลง', text: json.data.msg, callback: function () {
                                                                                            ele("btnExport3").enable();
                                                                                            // var filename = json.data.filename;
                                                                                            // window.location.href = 'Inventory/' + filename;
                                                                                        }
                                                                                    });
                                                                                }
                                                                                else {
                                                                                    webix.alert({
                                                                                        title: "<b>ข้อความจากระบบ</b>", type: "alert-warning", ok: 'ตกลง', text: json.data.msg, callback: function () {
                                                                                            ele("btnExport3").enable();
                                                                                            window.playsound(2);
                                                                                        }
                                                                                    });
