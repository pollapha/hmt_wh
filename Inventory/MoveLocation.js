var header_MoveLocation = function () {
    var menuName = "MoveLocation_", fd = "Inventory/" + menuName + "data.php";
    ...
    function exportExcel(btn) {
        ...
        if (dataT1.count() > 0) {
            ...
            worker.addEventListener('message', function (e) {
                saveAs(e.data, 'move_' + dayjs().format('YYYYMMDDHHmmss') + ".xlsx");
                btn.enable();
    ...
    function loadDataView(btn) {
        ...
        ajax("Inventory/MoveLocationView_data.php", obj, 1, function (json) {
    ...
    return {
        ...
        body:
        {
            ...
            rows:
                [
                    { view: "template", template: "Move Location", type: "header" },
                    {
                        padding: 8,
                        view: 'tabview',
                        id: $n("MasterTab"),
                                            ...
                                            [
                                                {
                                                    cols:
                                                        [
                                                            ...
                                                            vw1('text', 'tag_no', 'Case Tag No./ FG Tag No./ Part Tag No.', { disabled: false, required: true, hidden: 0 }),
                                                            {
                                                                rows: [
                                                                    {},
                                                                    ...
                                                                    webix.confirm(
                                                                        {
                                                                            ...
                                                                            callback: function (res) {
                                                                                if (res) {
                                                                                    ajax('Inventory/MoveLocationView_data.php', obj, 32, function (json) {
                                                                                        webix.alert({
                                                    ...
                                                    cols: [
                                                        {
                                                            ...
                                                            columns: [
                                                                ...
                                                                { id: "part_tag_no", header: [{ text: "Part Tag No.", css: { "text-align": "center" } }, { content: "textFilter" }], width: 150, css: { "text-align": "center" } },
                                                    ...
                                                    onClick:
                                                    {
                                                        ...
                                                        "mdi-cancel": function (e, t) {
                                                            ...
                                                            msBox('ยกเลิก', function () {
                                                                ajax('Inventory/MoveLocationView_data.php', row, 32, function (json) {
                                                                    webix.alert({
                                                                        title: "<b>ข้อความจากระบบ</b>", ok: 'ตกลง', text: 'ยกเลิกสำเร็จ', callback: function () {
                                                                            loadDataView();
                                                                        }
