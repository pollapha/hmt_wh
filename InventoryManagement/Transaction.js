                        ...
                        cols: [
                            {
                                ...
                                columns: [
                                    ...
                                    { id: "GRN_Number", header: ["GRN Number", { content: "textFilter" }], width: 180 },
                                    ...
                                    { id: "Creation_DateTime", header: ["Creation DateTime", { content: "textFilter" }], width: 150 },
                                    { id: "Created_By_ID", header: ["Created By ID", { content: "textFilter" }], width: 120 },
                                    { id: "Last_Updated_DateTime", header: ["Last Updated DateTime", { content: "textFilter" }], width: 150 },
                                    { id: "Updated_By_ID", header: ["Updated By ID", { content: "textFilter" }], width: 120 },
                                ],
                                onClick:
                                {
                                },
