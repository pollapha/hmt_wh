            ...
            rows: [
                {
                    cols: [
                        { width: 20 },
                        {
                            view: "template", borderless: true, width: 155,
                            css: "main_link",
                            template: "<image src=\"\images/dscm_th.jpg?v=2\" width=140px>",
                            onClick: {
                        ...
                        },
                        {
                            view: "template", borderless: true, width: 155,
                            css: "main_link",
                            template: "<image src=\"\images/hmt_logo.png?v=2\" width=120px>",
                            onClick: {
                                "main_link": () => (window.location = _getRootUrl)
                            }
                        },
            ...
            rows:
                [
                    ...
                    },
                    {
                        ...
                        multipleOpen: false,
                        width: 225,
                        scroll: true, data: _header_menuByRole, datatype: "json",
                        on:
                        {
                            onBeforeSelect: function (e) {
                                return this.getItem(e).$count ? !1 : void 0
