                                        ...
                                        },
                                        {
                                          cols:
                                            [
                                              ...
                                              {
                                                view: "button", value: "Save (บันทึกข้อมูล)", css: "webix_primary", id: "add_user_save",
                                                css:"webix_green",
                                                on:
                                                {
                                              ...
                                              {
                                                view: "button", value: "Refresh (โหลดใหม่)", id: "add_user_refresh",
                                            ...
                                            [
                                              {
                                                ...
                                                columns: [
                                                  ...
                                                  { id: "data2", header: "User Name", width: 300 },
                                                  { id: "data3", header: ["First Name (ชื่อ)", { content: "textFilter" }], width: 200 },
                                                  { id: "data4", header: ["Last Name (สกุล)", { content: "textFilter" }], width: 200 },
                                                  { id: "data5", header: ["Role", { content: "textFilter" }], width: 200 },
                                                  {
                                                ...
                                                autowidth: true, navigation: true, resizeColumn: true, headerRowHeight: 35,
          ...
          webix.ui(
            {
              ...
              head: "Edit User (แก้ไขข้อมูล)", top: 50, position: "center",
              body:
              {
                    ...
                    },
                    {
                      cols:
                        [
                          {},
                          {
                            view: "button", value: "OK", type: "form", width: 150, 
                            css:"webix_green", click: function () {
                          ...
                          {
                            view: "button", value: "Cancel", type: "danger", id: "add_user_clear_e", width: 150,
                            css:"webix_red", on:
                            {
