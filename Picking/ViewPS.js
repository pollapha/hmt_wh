                                    ...
                                    columns: [
                                        ...
                                        },
                                        {
                                            id: $n("icon_edit"), header: "&nbsp;", width: 40, template: function (row) {
                                                if (row.Is_Header == "YES" && row.Status_Shipping != 'DELIVERY' 
                                                && row.Status_Picking != 'CANCEL' && row.Ship_status != 'Y') {
                                        ...
                                        },
                                        {
                                            id: $n("icon_cancel"), header: "&nbsp;", width: 40, template: function (row) {
                                                if (row.Is_Header == "YES" && row.Status_Picking != 'CANCEL' && row.Ship_status != 'Y') {
