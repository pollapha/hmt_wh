var header_ReceiveEmptyPackage = function () {
    var menuName = "ReceiveEmptyPackage_", fd = "EmptyPackageControl/" + menuName + "data.php";
    ...
    function exportExcel(btn) {
        ...
        if (dataT1.count() > 0) {
            ...
            worker.addEventListener('message', function (e) {
                saveAs(e.data, 'receive_package' + dayjs().format('YYYYMMDDHHmmss') + ".xlsx");
                btn.enable();
    ...
    function loadDataView(btn) {
        ...
        ajax("EmptyPackageControl/ReceiveEmptyPackageView_data.php", obj, 1, function (json) {
    ...
    function reload_options_document_no() {
        ...
        documentList.load("common/documentNo.php?type=6");
    };
    ...
    return {
        view: "scrollview",
        scroll: "native-y",
        id: "header_ReceiveEmptyPackage",
        body:
        {
            id: "ReceiveEmptyPackage_id",
            type: "clean",
            rows:
                [
                    { view: "template", template: "Receive (Empty Package)", type: "header" },
                    {
                        padding: 8,
                        view: 'tabview',
                        id: $n("MasterTab"),
                                        ...
                                        rows: [
                                            {
                                                ...
                                                on: {
                                                    "onSubmit": function (view, e) {
                                                        ...
                                                        if (view.config.name == 'package_control_no') {
                                                            focus('package_no');
                                                        }
                                                                                ...
                                                                                webix.confirm(
                                                                                    {
                                                                                        ...
                                                                                        callback: function (res) {
                                                                                            if (res) {
                                                                                                ajax('EmptyPackageControl/ReceiveEmptyPackageView_data.php', obj, 32, function (json) {
                                                                                                    webix.alert({
                                                                                ...
                                                                                rows: [
                                                                                    {
                                                                                        cols: [
                                                                                            ...
                                                                                            vw1('text', 'package_control_no', 'Package Control No.', { disabled: false, required: false, hidden: 0 }),
                                                                                            {
                                                                                                rows: [
                                                                                                    {},
                                            ...
                                            },
                                            {
                                                ...
                                                on: {
                                                    "onSubmit": function (view, e) {
                                                        ...
                                                        if (view.config.name == 'package_no') {
                                                            ...
                                                            $.post(fd, { obj: obj, type: 3 })
                                                                .done(function (data) {
                                                                    var json = JSON.parse(data);
                                                                    if (json.ch == 1) {
                                                                        ele('steel_qty').setValue(json.data.steel_qty);
                                                                        ele('supplier_id').setValue(json.data.supplier_id);
                                                                        focus('steel_qty');
                                                                    }
                                                                    else if (json.ch == 2) {
                                                                        webix.alert({
                                                                                ...
                                                                                rows: [
                                                                                    {
                                                                                        cols: [
                                                                                            ...
                                                                                            vw1('text', 'package_no', 'Package No.', {
                                                                                                disabled: false, required: true, hidden: 0,
                                                                                                suggest: "common/packageMaster.php?type=1", Count: "5",
                                                                                                on: {
                                                                                                    // onChange: function () {
                                                                                                    //     focus('pallet_no');
                                                                                                    // }
                                                                                            ...
                                                                                            vw1('text', 'supplier_id', 'supplier_id', { disabled: false, required: false, hidden: 1, }),
                                                                                            {
                                                                                                rows: [
                                                                                                    {},
                                                                                ...
                                                                                cols: [
                                                                                    {
                                                                                        ...
                                                                                        columns: [
                                                                                            ...
                                                                                            { id: "package_no", header: [{ text: "Package No.", css: { "text-align": "center" } }, { content: "textFilter" }], width: 200, css: { "text-align": "center" }, },
                                                                                            { id: "package_type", header: [{ text: "Package Type", css: { "text-align": "center" } }, { content: "textFilter" }], width: 200, css: { "text-align": "center" }, footer: { text: "Total : ", css: { "text-align": "right" } } },
                                            ...
                                            [
                                                ...
                                                },
                                                {
                                                    ...
                                                    columns: [
                                                        ...
                                                        { id: "package_type", header: [{ text: "Package Type", css: { "text-align": "center" } }, { content: "textFilter" }], width: 100, css: { "text-align": "center" }, footer: { text: "Total : ", css: { "text-align": "right" } } },
                                                        { id: "steel_qty", header: [{ text: "Steel Pipe Qty", css: { "text-align": "center" } }, { text: " (Pcs.)", css: { "text-align": "center" } }], footer: { content: "summColumn", css: { "text-align": "center" } }, width: 100, css: { "text-align": "center" } },
                                                    ],
                                                    on:
                                                    {
                                                    ...
                                                    onClick:
                                                    {
                                                        ...
                                                        "mdi-cancel": function (e, t) {
                                                            ...
                                                            msBox('ยกเลิก', function () {
                                                                ajax('EmptyPackageControl/ReceiveEmptyPackageView_data.php', row, 32, function (json) {
                                                                    webix.alert({
                                                                        title: "<b>ข้อความจากระบบ</b>", ok: 'ตกลง', text: 'ยกเลิกสำเร็จ', callback: function () {
                                                                            loadDataView();
                                                                        }
