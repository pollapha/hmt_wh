var header_Receive = function () {
    ...
    function loadDataByDocumentNo() {
        ...
        ajax(fd, obj, 1, function (json) {
            if (json.data.header.length > 0) {
                ...
                setTable('dataT1', json.data.body);
                ele('btn_save').enable();
                ele('btn_cancel').enable();
            }
            else {
                ele('form1').setValues('');
                ele('document_date').setValue(new Date());
                ele('dataT1').clearAll();
                ele('btn_save').disable();
    ...
    function CheckPallet() {
        var obj1 = ele('form1').getValues();
        var obj3 = ele('formscan').getValues();
        var obj = { ...obj1, ...obj3 };

        $.post(fd, { obj: obj, type: 14 })
            .done(function (data) {
                var json = JSON.parse(data);
                if (json.ch == 1) {
                    webix.message({
                                ...
                                elements: [
                                    {
                                        rows: [
                                                                                                            ...
                                                                                                            webix.ajax("print/doc/part_tag_by_docno.php?data=" + data).then(function () {
                                                                                                                webix.ajax("print/doc/merge_grn.php?data=" + data).then(function () {
                                                                                                                    setTimeout(function () {
                                                                                                                        ...
                                                                                                                        window.open("print/doc/files/grn/grn_doc/TAG_" + data + '.pdf', '_blank');
                                                                                                                        /* temp.addEventListener('load', function () {
                                                                                                                            var temp1 = window.open("print/doc/remove_file.php?data=" + 'files/grn/case_tag/' + data + '.pdf');
                                                                                                                            var temp2 = window.open("print/doc/remove_file.php?data=" + 'files/grn/part_tag/' + data + '.pdf');
                                                                                                                            temp1.close();
                                                                                                                            temp2.close();
                                                                                                                        }, false); */
                                                                                                                    }, 50);
                                                                                ...
                                                                                rows: [
                                                                                    {
                                                                                        cols: [
                                                                                            ...
                                                                                            vw1('text', 'part_no', 'Part No.', {
                                                                                                disabled: false, required: true, hidden: 0, width: 220,
                                                                                            ...
                                                                                            vw1('text', 'pallet_no', 'Pallet No.', { disabled: false, required: true, hidden: 0, width: 220 }),
                                                                                            vw1('text', 'net_per_pallet', 'Net(Kg.)', { disabled: false, required: true, hidden: 0, width: 220 }),
                                                                                            vw1('text', 'qty', 'Qty(pcs.)', { disabled: false, required: true, hidden: 0, }),
                                                                                        ]
                                                                                    },
                                                                                    {
                                                                                        cols: [
                                                                                            vw1('text', 'certificate_no', 'Certificate No.', { disabled: false, required: true, hidden: 0, width: 220 }),
                                                                                            vw1('text', 'gross_kg', 'Gross(Kg.)', { disabled: false, required: false, hidden: 0, placeholder: '0', width: 220 }),
                                                                                            vw1('text', 'measurement_cbm', 'Measurement(CBM)', { disabled: false, required: false, hidden: 0, placeholder: '0.00', width: 220 }),
                                                                                            {}
                                                                                        ]
                                                                                    },
                                                                                    {
                                                                                    ...
                                                                                    },
                                                                                    {
                                                                                        cols: [
                                                                                            ...
                                                                                            vw1('button', 'btn_upload_plan', 'Upload Packing List', {
                                                                                                ...
                                                                                                on: {
                                                                                                    onItemClick: function () {
                                                                                                        var invoice_no = ele('invoice_no').getValue();
                                                                                                        if (invoice_no == '') {
                                                                                                            webix.alert({
                                                                                                                title: "<b>ข้อความจากระบบ</b>", ok: 'ตกลง', type: 'alert-error',
                                                                                                                text: 'กรุณากรอกข้อมูล Invoice ก่อน', callback: function () {
                                                                                                                    focus('invoice_no');
                                                                                                                }
                                                                                                            });
                                                                                                        } else {
                                            ...
                                            {
                                                view: "form", scroll: false, id: $n('formscan'),
                                                on: {
                                                    "onSubmit": function (view, e) {

                                                        if (view.config.name == 'receive_check') {
                                                            focus('receive_check');
                                                            CheckPallet();
                                                        }
                                                        ...
                                                        rows: [
                                                            {
                                                                rows:
                                                                    [
                                                                        {
                                                                            cols: [
                                                                                vw1('text', 'receive_check', 'Scan Check', { disabled: false, required: false, hidden: 0, labelPosition: 'left', placeholder: 'Pallet No.' }),
                                                                                {}
                                                                            ]
                                                                        },
                                                                        {
                                                                                ...
                                                                                cols: [
                                                                                    {
                                                                                        ...
                                                                                        columns: [
                                                                                            ...
                                                                                            { id: "receive_check", header: [{ text: "receive_check", css: { "text-align": "center" } }, { content: "textFilter" }], width: 150, css: { "text-align": "center" }, hidden: 1 },
