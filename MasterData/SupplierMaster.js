    ...
    function exportExcel(btn) {
        ...
        if (dataT1.count() > 0) {
            ...
            worker.addEventListener('message', function (e) {
                saveAs(e.data, 'supplier_master' + dayjs().format('YYYYMMDDHHmmss') + ".xlsx");
                btn.enable();
                                            ...
                                            [
                                                {
                                                    cols: [
                                                        ...
                                                        vw1('text', 'supplier_name', 'Supplier Name', {}),
                                                    ],
                                                },
                                            ]
                                    }
                                ...
                                [
                                    {
                                        ...
                                        rows:
                                            [
                                                {
                                                    cols: [
                                                        vw1('text', 'supplier_id', 'Supplier ID', { hidden: 1 }),
                                                        vw2('text', 'supplier_code_edit', 'supplier_code', 'Supplier Code', { disabled: false, }),
                                                        vw2('text', 'supplier_name_edit', 'supplier_name', 'Supplier Name', {  }),
                                                    ],
                                                },
                                                {
                                                    cols: [
