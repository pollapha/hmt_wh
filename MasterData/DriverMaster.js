    ...
    function exportExcel(btn) {
        ...
        if (dataT1.count() > 0) {
            ...
            worker.addEventListener('message', function (e) {
                saveAs(e.data, 'driver_master' + dayjs().format('YYYYMMDDHHmmss') + ".xlsx");
                btn.enable();
                                ...
                                [
                                    {
                                        ...
                                        rows:
                                            [
                                                {
                                                    cols: [
                                                        vw1('text', 'driver_name', 'Driver Name', {}),
                                                        vw1('text', 'driver_phone', 'Phone', {}),
                                                    ],
                                                },
                                            ]
                                    }
                                ...
                                [
                                    {
                                        ...
                                        rows:
                                            [
                                                {
                                                    cols: [
                                                        vw1('text', 'driver_id', 'driver_id', { labelPosition: "top", hidden: 1 }),
                                                        vw2('text', 'driver_name_edit', 'driver_name', 'Driver Name', {}),
                                                        vw2('text', 'driver_phone_edit', 'driver_phone', 'Phone', {}),
                                                    ],
                                                },
                                                {
                                                    cols: [
                                ...
                                cols: [
                                    {
                                        ...
                                        columns: [
                                            ...
                                            { id: "driver_phone", header: [{ text: "Phone", css: { "text-align": "center" } }, { content: "textFilter" }], width: 150, css: { "text-align": "center" }, },
