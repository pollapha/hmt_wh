    ...
    function exportExcel(btn) {
        ...
        if (dataT1.count() > 0) {
            ...
            worker.addEventListener('message', function (e) {
                saveAs(e.data, 'truck_master' + dayjs().format('YYYYMMDDHHmmss') + ".xlsx");
                btn.enable();
                                ...
                                [
                                    {
                                        ...
                                        rows:
                                            [
                                                {
                                                    cols: [
                                                        vw1('text', 'truck_number', 'Truck Number', {}),
                                ...
                                [
                                    {
                                        ...
                                        rows:
                                            [
                                                {
                                                    cols: [
                                                        vw1('text', 'truck_id', 'truck_id', { labelPosition: "top", hidden: 1 }),
                                                        vw2('text', 'truck_number_edit', 'truck_number', 'Truck Number', {}),
                                ...
                                cols: [
                                    {
                                        ...
                                        columns: [
                                            ...
                                            { id: "truck_number", header: [{ text: "Truck Number", css: { "text-align": "center" } }, { content: "textFilter" }], width: 180, css: { "text-align": "center" }, },
                                            { id: "truck_type", header: [{ text: "Truck Type", css: { "text-align": "center" } }, { content: "textFilter" }], width: 150, css: { "text-align": "center" }, },
